...
interface ProductCommunityChatRoomFixedWithEnhancedInputProps {
  isOpen: boolean;
  onClose: () => void;
  product: Product;
  currentUser: any;
...
export function ProductCommunityChatRoomFixedWithEnhancedInput({
  isOpen,
  onClose,
  product,
  currentUser,
  isMobile = false
}: ProductCommunityChatRoomFixedWithEnhancedInputProps) {
    ...
    <AnimatePresence>
      {isOpen && (
        ...
        >
          ...
          {/* Content - Reviews Tab Only */}
          <div className="flex flex-col h-full">
            {/* Tab Header */}
            <div className="bg-gray-50 border-b border-gray-200 p-4">
              <h4 className="font-heading text-md font-medium text-gray-900 flex items-center gap-2">
