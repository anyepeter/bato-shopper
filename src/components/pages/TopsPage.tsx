...
export function TopsPage({
  ...
  // Filter to show only tops
  const tops = filteredProducts.filter(product => product.category === 'tops');
      ...
      <div className={layoutClasses.container}>
        ...
        <div className={layoutClasses.middlePanel}>
          <div className="shop-featured-banner">
            <h2>Stylish Tops Collection</h2>
            <p>Find the perfect African-inspired tops for any occasion</p>
          ...
          <div className="shop-products-container">
            {paginatedProducts.length === 0 ? (
              <div className="shop-empty-state">
                ...
                <h3 className="shop-empty-state-title">No tops found</h3>
